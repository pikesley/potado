...
class TestHome:
    ...
    def test_complex_data(self, mock_schedule, mock_settings, mock_credentials):
    ...
    def test_modeless_generation(self, mock_schedule, mock_settings, mock_credentials):
    ...
    def test_whole_week(self, mock_schedule, mock_settings, mock_credentials):
